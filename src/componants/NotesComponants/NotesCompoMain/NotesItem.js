...
function NoteItem({ Note }) {
  ...
  return (
      <div style={{borderRadius:"5px 5px 5px 5px"}}
          className={`flex h-full w-full my-2  px-3 py-1 fs-6 gap-x-3 shadow-sm shadow-white/50  text-black  ${
      ...
      >
          ...
          <input
              ...
              className={`border outline-none   w-full bg-transparent rounded-lg ${
                  isNoteEditable ? "border-black/10 px-5 py-5" : "border-transparent"
