...
export default function SecondCompoBody() {
  ...
  useEffect(() =>{
    ...
    setTimeout(() => {
      ...
      addImage.current.src = `${data.image.small}`
        ...
        <div className="row">
          <div className="col-12 col-sm-3">
            <h6 className="fs-6">
              Current Coin :{" "}
              <span
                className="fs-5 text-warning" style={{display:"inline-block"}}>
                {data.id}
                
                  <img ref={addImage}  alt="Coin" className="ms-2" style={{width :" 20px", height : "20px",display:"inline-block"}} />
